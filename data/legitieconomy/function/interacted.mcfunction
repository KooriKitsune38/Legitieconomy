...
execute on target unless score @s confirm matches -2147483648..2147483647 run tellraw @s [{text:"| ",color:"dark_gray"},{text:"Trigger \"confirm\" if you're sure, then click again.",color:"aqua"}]
