...
execute if entity @s[tag=le.goldenReef,scores={le.gadgetEntity=1}] as @p[distance=..1.1,predicate=legitieconomy:on_ground] run function legitieconomy:coins/earn_coins {coins:1}
