...
execute align xyz run summon text_display ~.5 ~.5 ~.5 {Tags:[le.tempSeat]}
execute align xyz positioned ~.5 ~.5 ~.5 run ride @s mount @n[type=text_display,tag=le.tempSeat,distance=..1]