...
execute on target unless score @s price matches 1.. unless score @s price matches -1 run return run tellraw @s [{text:"| ",color:"dark_gray"},{text:"Trigger \"price\" to set the price for the item, then click again.",color:"green"}]
