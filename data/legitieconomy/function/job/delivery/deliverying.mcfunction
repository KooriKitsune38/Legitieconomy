...
execute at @s if entity @n[type=item_display,tag=le.deliveryBox,predicate=legitieconomy:job/delivery_uuid,distance=..2] run function legitieconomy:job/delivery/complete_delivery
